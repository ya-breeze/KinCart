...
## Requirement: Login
A user must authenticate with username and password to access the app.
...
Sessions survive page reloads without requiring re-login.
...
## Requirement: Logout
Logging out clears the session and prevents further access.
