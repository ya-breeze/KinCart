...
## Purpose
Manage shops and their aisle (category) ordering to route shopping lists by store layout.

## Requirements

### Requirement: Manage shops

The manager SHALL be able to create, rename, and delete shops from the Settings page.
...
Each shop MAY have a custom category order defining the in-store aisle layout, and the system SHALL apply it when that shop is selected.
...
The system SHALL let a user select a shop on the list detail page.
