...
## Purpose
Let users organize items into named, ordered categories used for grouping and aisle routing.

## Requirements

### Requirement: Manage categories

The manager SHALL be able to create, edit, reorder, and delete categories from the Settings page.
...
Categories SHALL have a defined display order that controls grouping in list detail.
...
Items SHALL be assignable to a category when added or edited.
